...
const SignupForm = () => (
  <div className="min-h-screen bg-gray-100 flex items-center justify-center">
    <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-bold text-center text-teal-600 mb-6">Sign Up for an Account</h2>
      ...
      <p className="text-sm text-gray-600 mt-4">
        Already have an account? <a href="#" className="text-teal-600 hover:text-teal-700">Log In</a>
      </p>
    </div>
  </div>
);
